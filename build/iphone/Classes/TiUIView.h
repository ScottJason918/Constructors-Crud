...
/**
 Base class for all ConstructorsCrud views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the ConstructorsCrud view hierarchy (such as wrapped iOS UIViews) was touched.
