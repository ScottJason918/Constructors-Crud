...
@interface ConstructorsCrudObject : KrollCoverageObject {
#else
@interface ConstructorsCrudObject : KrollObject {
#endif
@private
...
extern NSString * ConstructorsCrud$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	ConstructorsCrudObject *_constructorscrud;
    KrollObject* console;
	BOOL shutdown;
