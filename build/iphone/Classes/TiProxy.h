...
//Rare exceptions to indicate a bug in the _constructorscrud code (Eg, function that a subclass should have implemented)
...
/**
 The base class for ConstructorsCrud proxies.
 */
