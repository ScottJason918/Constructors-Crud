...
// in simulator we redefine to format for ConstructorsCrud Developer console
...
{\
	NSString * exceptionName = [@"org.constructorscrud." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.constructorscrud";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIConstructorsCrudNativeItemNone = -1, 
	UIConstructorsCrudNativeItemSpinner = -2,
	UIConstructorsCrudNativeItemProgressBar = -3,
	
	UIConstructorsCrudNativeItemSlider = -4,
	UIConstructorsCrudNativeItemSwitch = -5,
	UIConstructorsCrudNativeItemMultiButton = -6,
	UIConstructorsCrudNativeItemSegmented = -7,
	
	UIConstructorsCrudNativeItemTextView = -8,
	UIConstructorsCrudNativeItemTextField = -9,
	UIConstructorsCrudNativeItemSearchBar = -10,
	
	UIConstructorsCrudNativeItemPicker = -11,
	UIConstructorsCrudNativeItemDatePicker = -12,
	
	UIConstructorsCrudNativeItemInfoLight = -13,
	UIConstructorsCrudNativeItemInfoDark = -14,
	
	UIConstructorsCrudNativeItemDisclosure = -15,
	
	UIConstructorsCrudNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all ConstructorsCrud instances of
