...
//@interface ConstructorsCrudObject : NSObject
//@end

@interface ConstructorsCrudObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[ConstructorsCrudObject class]])
		{
			for (NSString *key in [[(ConstructorsCrudObject*)o modules] allKeys])
			{
